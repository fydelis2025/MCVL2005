...
Begin VB.Form frmatendentes 
   ...
   End
End
Attribute VB_Name = "frmatendentes"
...
If KeyCode = vbKeyReturn Then
    SendKeys "{TAB}"
            ...
            If Nome.Text = Empty Then
                MsgBox "Informe o nome do atendente!", vbInformation
            Exit Sub
            End If
