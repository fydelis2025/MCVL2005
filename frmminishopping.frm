...
Begin VB.Form frmminishopping 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Venda de Mini Shopping"
   ClientHeight    =   1470
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5160
   Icon            =   "frmminishopping.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   1470
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin VB.CommandButton CmdSalvar 
         Height          =   495
         Left            =   4680
         Picture         =   "frmminishopping.frx":0CCA
         Style           =   1  'Graphical
         TabIndex        =   10
         Top             =   840
         Width           =   375
      ...
      Begin VB.CommandButton CmdNovo 
         Height          =   495
         Left            =   4680
         Picture         =   "frmminishopping.frx":1994
         Style           =   1  'Graphical
         TabIndex        =   9
         Top             =   240
         Width           =   375
   ...
   End
End
Attribute VB_Name = "frmminishopping"
      ...
      Select Case MsgBox("Deseja Salvar Alterações ?", vbQuestion + vbYesNo)
        Case vbYes '6
          If Descricao.Text = Empty Then
             ...
             Exit Sub
          If Venda.Text = Empty Then
             MsgBox "O campo tipo de venda esta vasio!", , "Gravar "
             Venda.SetFocus
             Save = False 'nao salva os dados
             Action = vbDataActionCancel 'Cancela acao
             Exit Sub
